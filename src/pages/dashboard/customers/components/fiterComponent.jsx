...
import { paymentStatus } from "../../transactionHistory/components/data";
  ...
  return (
    <Container>
      ...
      <SMSelectDropDown
        ...
        onChange={(selectedOption) => handleChange("payment", selectedOption)}
      />
      <ButtonWrapper>
        <Button buttonClass={"primary"} label={"Cancel"} />
        <Button
          buttonClass={"primary"}
          label={"Filter"}
